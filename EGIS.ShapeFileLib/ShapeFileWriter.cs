...
namespace EGIS.ShapeFileLib
{
    ...
    public abstract class ShapeFileWriter : IDisposable
    {
        ...
        private static byte[] ShapeFileHeaderBytes =
        ...
        private System.Text.UTF8Encoding utf8 = new UTF8Encoding();
    ...
    [ObfuscationAttribute(Exclude = true, ApplyToMembers = true)]
    internal class PolygonShapeFileWriter : ShapeFileWriter
    {
    ...
    [ObfuscationAttribute(Exclude = true, ApplyToMembers = true)]
    internal class PolyLineShapeFileWriter : ShapeFileWriter
    {
        private bool useMeasures = false;
        private bool useZValues = false;
    ...
    [ObfuscationAttribute(Exclude = true, ApplyToMembers = true)]
    internal class PointShapeFileWriter : ShapeFileWriter
    {
